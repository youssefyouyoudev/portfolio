...
export const authorityPages: Record<string, AuthorityPageContent> = {
  ...
  "hire-laravel-react-developer": {
    slug: "hire-laravel-react-developer",
    title: "Hire a Laravel, React and Next.js Developer | Youssef Youyou",
    description: "Hire Youssef Youyou, a full-stack Laravel, React and Next.js developer from Morocco for websites, APIs, dashboards, SaaS MVPs and remote roles.",
    h1: "Hire a Laravel, React and Next.js Developer",
    eyebrow: "Hiring Funnel",
    intro: "Hire a Laravel, React and Next.js full-stack developer for websites, dashboards, APIs, SaaS MVPs and business automation systems. I am based in Nador, Morocco and available for freelance projects, remote collaboration, agency support and serious hiring conversations.",
    sections: [
      { title: "Why hire me", body: ["I combine Laravel backend work, React/Next.js frontend development, MySQL data modeling, dashboard workflows, SEO structure and production deployment thinking. My portfolio is built around real project proof, honest case studies and practical technical writing instead of exaggerated claims."], items: ["Laravel APIs", "React/Next.js interfaces", "Admin dashboards", "SaaS foundations", "Business automation"] },
      { title: "What I can contribute", body: ["I can help teams build business websites, admin dashboards, Laravel APIs, React/Next.js frontends, SaaS MVPs, client portals, booking platforms, inventory/HR systems, Excel/VBA replacement tools and SEO-ready landing pages. I also help with deployment issues around Nginx, PM2, Vite, Laravel cache and Cloudflare."], items: ["Freelance project", "Remote contract", "Part-time collaboration", "Agency support", "Internal tool development"] },
      { title: "Project examples", body: ["RiFiTV shows Laravel/Vite media platform work and deployment troubleshooting. ERPlus shows Laravel API plus React/Vite dashboard direction for HR, inventory and business workflows. The Portfolio Admin System shows admin-editable content, messages, CV tracking and SEO fields. The digital archiving and Excel/VBA projects show automation and administrative workflow context."] },
      { title: "Technical strengths", body: ["Laravel, PHP, React, Next.js, JavaScript, TypeScript where useful, MySQL, REST APIs, Tailwind CSS, Git, Nginx, Cloudflare, SEO metadata, schema, sitemap/robots and production deployment checks. I focus on maintainable structure, clear API contracts and business value."] },
      { title: "Availability", body: ["I am available for Morocco-based clients, remote teams, recruiters and agencies. The best fit is Laravel APIs, React/Next.js dashboards, admin panels, SaaS MVPs, automation tools and production deployment support."] },
    ],
    faqs: [
      { question: "How fast can you start?", answer: "It depends on current workload and project scope. Send the role or project details and I can confirm realistic availability." },
      { question: "Do you work remotely?", answer: "Yes. I work remotely with clear scope, Git workflow, written notes and practical communication." },
      { question: "Do you build Laravel APIs?", answer: "Yes. Laravel APIs, validation, resources, policies, auth, roles and MySQL schemas are a core strength." },
      { question: "Can you work with React and Next.js?", answer: "Yes. I build React dashboards, Next.js SEO pages and frontend interfaces connected to Laravel APIs." },
      { question: "Can you fix existing projects?", answer: "Yes. I can review existing Laravel, React, Next.js, deployment or SEO structures and propose practical fixes." },
      { question: "Do you provide deployment help?", answer: "Yes. I can help with Ubuntu, Nginx, PM2, SSL, Laravel cache, Vite assets and Cloudflare-facing issues." },
    ],
    cta: "Contact me about a role, project or collaboration.",
  },
