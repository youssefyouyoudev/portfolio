export const profile = {
  ...
  heroPromise:
    "I build Laravel and React business systems: dashboards, APIs, SaaS foundations and practical workflow automation.",
  positioning:
    "Full-Stack Laravel, React & Next.js Developer | APIs | Dashboards | SaaS | Business Automation",
  location: "Nador, Morocco",
  availability:
    "Available for freelance, remote and business web projects in Morocco and internationally",
  description:
    "Based in Nador and available across Morocco or remotely, I turn practical business workflows into maintainable Laravel, React and Next.js systems.",
...
export const stats = [
  ...
  { value: "4", label: "Featured systems", detail: "ERPlus, RiFiTV, this portfolio platform and internal digitalization work are presented with their real delivery status.", tone: "Proof of work" },
  { value: "2", label: "Internal tools", detail: "Digital archiving and Excel/VBA automation reflect internal administrative workflow work without exposing confidential data.", tone: "Workflow proof" },
  { value: "2", label: "Concept explorations", detail: "SaaS and commerce explorations are clearly separated from implemented systems.", tone: "Clear scope" },
...
export const projects = [
  ...
  },
  {
    ...
    shortDescription: "A multi-module Laravel and React business platform for structured company workflows across HR, inventory, finance and collaboration.",
    ...
    seoTitle: "ERPlus Case Study — Laravel & React ERP Platform | Youssef Youyou",
    seoDescription: "ERPlus is a Laravel and React multi-module business platform for company-scoped HR, inventory, finance and collaboration workflows.",
    stack: ["Laravel", "React", "Vite", "MySQL", "Tailwind CSS", "REST API", "Nginx"],
    features: ["Global dashboard", "Human resources workflows", "Inventory and warehouse records", "Finance workflows", "Collaboration workspace", "Company-scoped access", "API-driven frontend"],
    businessValue: "Brings fragmented operational records into a structured company-scoped platform without presenting it as a certified accounting or payroll product.",
    problems: ["Separating frontend and backend concerns", "Defining company-scoped workflows", "Maintaining clear module boundaries", "Managing Laravel/Vite deployment configuration"],
    businessProblem: "Teams often handle HR, inventory, finance and collaboration work across disconnected files and tools, making operational context difficult to follow.",
    ...
    myRole: "Full-stack architecture, Laravel API and React/Vite implementation, dashboard workflows, data modelling and deployment troubleshooting.",
    targetUsers: "Small business teams, HR/admin users and managers who need clearer operational dashboards.",
    deliverables: ["Laravel REST API", "React/Vite dashboard", "Company-scoped business modules", "HR and inventory workflows", "Finance and collaboration areas", "Deployment configuration"],
    architecture: "React/Vite frontend connected to a Laravel REST API and MySQL data model, with business modules organized around a company context.",
    impact: "Creates an engineering-focused foundation for centralizing business workflows while keeping the current delivery boundary explicit.",
    recruiterSignal: "Shows full-stack separation, API contracts, business-module design, dashboard UX and deployment awareness.",
  ...
  },
  {
    ...
    shortDescription: "Internal administrative digitalization work for organizing, finding and tracking documents without exposing confidential records.",
    ...
    impact: "Supported clearer document access and repeatable administrative tracking; no unverified time-saving claim is made.",
  ...
  {
    title: "Youssef Control",
    slug: "youssef-control",
    category: "Server management / operations control panel / security",
    subtitle: "Server Management & Operations Control Panel — Next.js — Laravel",
    shortDescription: "An authentication-gated operations panel for managing websites, services, deployments and operational visibility with security controls built into sensitive workflows.",
    caseStudyUrl: "/projects/youssef-control",
    image: "",
    imageAlt: "Youssef Control private server operations interface",
    seoTitle: "Youssef Control Case Study — Laravel & Next.js Operations Panel | Youssef Youyou",
    seoDescription: "A Laravel and Next.js server management control panel with website discovery, approved operations, audit history and deliberately constrained sensitive tools.",
    stack: ["Next.js", "Laravel", "MySQL", "Nginx", "Linux", "PM2", "Cloudflare"],
    features: ["Website and service visibility", "Deployment and health workflows", "Allowlisted operational actions", "Audit history", "Two-factor authentication", "Read-only database mode", "Restricted terminal sessions"],
    businessValue: "Centralizes operational visibility while deliberately constraining sensitive actions and preserving an auditable trail.",
    problems: ["Scattered server visibility", "Uncontrolled operational commands", "Sensitive log and credential exposure", "Unclear deployment state"],
    businessProblem: "Managing websites and server operations through disconnected commands and panels makes routine work hard to review and sensitive actions difficult to govern.",
    solution: "A split Next.js and Laravel application for discovering websites, reviewing operational status and running only configured actions with authentication, audit and safety boundaries.",
    myRole: "Full-stack product architecture, Laravel API, Next.js operations UI, security-oriented workflow design and infrastructure integration.",
    targetUsers: "Authorized operators managing a defined set of websites and services.",
    deliverables: ["Operations dashboard", "Website discovery", "Deployment visibility", "Audited actions", "Security status", "Restricted terminal and database tooling"],
    architecture: "Next.js frontend connected to a Laravel API and MySQL, with Nginx/Linux discovery and explicitly allowlisted operational integrations.",
    impact: "Demonstrates how an internal operations product can balance useful visibility with conservative controls around high-risk capabilities.",
    recruiterSignal: "Shows full-stack architecture, security constraints, operations workflows, auditability and a thoughtful approach to high-risk tooling.",
    learned: "Sensitive operations interfaces need explicit defaults, narrow permissions and auditability—not just a polished dashboard.",
  },
];
