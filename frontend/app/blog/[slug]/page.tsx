  ...
  const structuredData = [
    {
      ...
      headline: post.title,
      description: post.excerpt,
      url: `https://www.youssefyouyou.com/blog/${post.slug}`,
      ...
      mainEntityOfPage: `https://www.youssefyouyou.com/blog/${post.slug}`,
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Blog", item: "https://www.youssefyouyou.com/blog" },
        { "@type": "ListItem", position: 3, name: post.title, item: `https://www.youssefyouyou.com/blog/${post.slug}` },
      ],
    },
  ];
