...
export function FloatingDashboardVisual() {
  ...
  return (
    ...
    >
      <div className="absolute -inset-5 rounded-[2.5rem] bg-cyan-400/18 blur-3xl" />
      <div className="absolute -right-8 top-12 hidden h-44 w-44 rounded-full bg-blue-500/18 blur-3xl sm:block" />

      <GlassCard className="relative overflow-hidden rounded-[2rem] p-2 ring-1 ring-white/5">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_20%,rgba(34,211,238,.2),transparent_34%),linear-gradient(135deg,rgba(15,23,42,.58),rgba(2,6,23,.9))]" />
        <div className="relative flex h-9 items-center gap-2 rounded-t-[1.45rem] border-b border-white/10 bg-slate-950/70 px-4">
          <span className="h-2.5 w-2.5 rounded-full bg-rose-400/80" />
          <span className="h-2.5 w-2.5 rounded-full bg-amber-300/80" />
          <span className="h-2.5 w-2.5 rounded-full bg-emerald-300/80" />
          <span className="ml-3 text-xs text-slate-400">production-dashboard.tsx</span>
        </div>
      ...
      <FloatingCard delay={0.25} className="absolute -left-3 top-8 hidden w-56 md:block">
        <GlassCard className="rounded-2xl p-4 ring-1 ring-cyan-300/10">
          <div className="flex items-center justify-between text-xs text-slate-400">
            <span>API Request</span>
            <Server size={15} className="text-cyan-300" />
          </div>
          <div className="mt-3 rounded-xl border border-cyan-400/15 bg-[#020617]/70 p-3 font-mono text-xs">
            <p className="text-sky-300">GET /api/projects</p>
      ...
      <FloatingCard delay={0.55} className="absolute -right-2 top-16 hidden w-48 lg:block">
        <GlassCard className="rounded-2xl p-4 ring-1 ring-cyan-300/10">
          ...
          <p className="mt-3 text-4xl font-black text-white">98</p>
          <p className="text-xs text-cyan-200">SEO-ready score</p>
        </GlassCard>
      </FloatingCard>
      ...
      <FloatingCard delay={0.85} className="absolute -bottom-5 left-8 hidden w-64 sm:block">
        <GlassCard className="rounded-2xl p-4 ring-1 ring-cyan-300/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-white">Laravel + React + MySQL</p>
              <p className="text-xs text-slate-400">Production-oriented stack</p>
            </div>
          </div>
        </GlassCard>
      </FloatingCard>
